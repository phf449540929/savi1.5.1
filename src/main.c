...
int main(int argc, char *argv[]) {
    ...
    if (!tcl_init(interp)) {
        /**
         * unsigned int tcl_init(Tcl_Interp *interpreter) is in tcl_utils.c
         */
    ...
    if (!tk_init(interp)) {
        /**
         * unsigned int tk_init(Tcl_Interp *interpreter) is in tcl_utils.c
         */
    ...
    if (!tcl_script(buf)) {
        /**
         * proc main(update) is in main.tcl
         */
